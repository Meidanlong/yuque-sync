...
def push_github_origin(file_path: str, file_content: str, commit_message: str):
    ...
    try:
        # 检查文件是否在仓库中
        contents = repo.get_contents('content/{file_path}'.format(file_path=file_path), ref="refs/heads/" + REPO_BRANCH)
...
if __name__ == '__main__':
    ...
    push_github_origin(file_path, file_content, commit_message)
